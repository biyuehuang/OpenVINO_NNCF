...
def preprocess_for_eval(image, label):
    image = center_crop(image, 299, 32)
...
val_dataset = val_dataset.map(preprocess_for_eval).batch(1)
...
fp32_ir_path = "/home/kiwi/ov/uniview/Inception/inception-resnet-v2-tf/FP32/inception-resnet-v2-tf.xml"
int8_ir_path = "/home/kiwi/ov/uniview/Inception/inception-resnet-v2-tf/INT8/inception-resnet-v2-tf.xml"

ov_model = ov.Core().read_model(fp32_ir_path) #mo.convert_model(tf_model)
...
fp32_fps = run_benchmark(fp32_ir_path, shape=[1, 299, 299, 3], verbose=True)
print("[4/7] Benchmark INT8 model:")
int8_fps = run_benchmark(int8_ir_path, shape=[1, 299, 299, 3], verbose=True)
